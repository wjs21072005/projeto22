...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    //CRIAPTOGRAFAR A IMAGEM QUE IRÁ PARA O BANCO
    ...
    if($imagem_atual == $imagem_base64){
        ...
        $sql = "UPDATE produtos SET pro_nome = '$nome', pro_descricao = '$descricao', pro_quantidade = $quantidade, pro_custo = $custo, pro_preco =

        $preco, pro_ativo = '$ativo' WHERE pro_id = '$id'";
        ...
        $preco, pro_ativo = '$ativo', imagem1 = '$imagem_base64' WHERE pro_id = '$id'";
